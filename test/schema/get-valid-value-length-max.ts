...
describe('getValidValueLengthMax', function(){
  it('should return max length for path', async () => {
    ...
    const validValues = schema.getValidValueLengthMax('model');
  ...
  it('should return max length for array path', async () => {
    ...
    const validValues = schema.getValidValueLengthMax('model.*.synth');
  ...
  it('should return max length for deep path', async () => {
    ...
    const validValues = schema.getValidValueLengthMax('model.synth.bestSeller');

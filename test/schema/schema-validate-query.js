...
describe('Schema', function() {
  describe('validateQuery', function() {
    it('should cast query parameters', function(done) {
      var data = {
        name: {$eq: 123},
        age: {$lt: '33'},
        cityId: {$in: ['10', '11', '12']},
      ...
      schema.validateQuery(data).then(() => {
    ...
    it('should cast query parameters within conditional $or', function(done) {
      var data = {
        '$or': [
          {name: {$eq: 123}},
          {name: {$eq: 456}}
    ...
    it('should cast query parameters within conditional $and', function(done) {
      var data = {
        '$and': [
          {name: {$eq: 123}},
          {age: {$eq: '35'}}
    ...
    it('should cast query parameters within nested conditionals', function(done) {
      var data = {
        '$or': [
          {
            '$and': [

...
class Validator {
    static validate(value, validatorsConfig, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let x = 0; x < configKeys.length; x++) {
                ...
                if (validatorsConfig[validatorName] === false || validatorsConfig[validatorName] == undefined)
                    continue; // Falsey value disables the validator
                ...
                for (let y = 0; y < validatorConfig.length; y++) {
                    ...
                    if (results === true) {
                        ...
                        let resultCurrent = yield Promise.resolve(validatorFn(value, config));
    ...
    static isEmpty(value) {
        var valueType = value ? type_caster_1.default.getType(value) : undefined;
    ...
    static valueLength(value, options) {
        ...
        var valueType = type_caster_1.default.getType(value);

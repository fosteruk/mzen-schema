...
var Schema = function () {
  ...
  _createClass(Schema, [{
    ...
    value: function filterPrivate(object, mode) {
      ...
      this.mapper.map(object, function (fieldSpec, fieldName, fieldContainer, path) {
        ...
        if (filters['private'] === true || filters['private'] == mode) {
          if (fieldContainer.hasOwnProperty(fieldName)) delete fieldContainer[fieldName];
        }
      });
    }
  }, {
    ...
    key: 'validateField',
    value: function validateField(spec, fieldName, value, path, options) {
      ...
      if (fieldType == Object) {
        var strict = options['strict'] !== undefined ? options['strict'] : this.options['strict'];

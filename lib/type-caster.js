...
class TypeCaster {
  ...
  static cast(toType, value) {
    ...
    var result = value; // If there is a cast function for toType then we cast the value
...
TypeCaster.type = {
  ...
  Object: {},
  // Object is a valid type but we can not cast a primitive to an object so it has no cast methods
  Array: {},
  // Array is a valid type but we can not cast a primitive to an object so it has no cast methods
  Date: TypeCasterDate,
